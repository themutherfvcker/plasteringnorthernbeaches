      ...
      <section className="bg-white px-4 py-16 md:py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <blockquote className="bg-navy-50 border-l-4 border-brand-500 rounded-r-xl p-6"><p className="text-navy-800 italic leading-relaxed mb-3">&ldquo;Roof tile blew off in the wind, water came through overnight. Plumber sealed it but the ceiling section needs replacing.&rdquo;</p><p className="text-navy-500 text-sm font-semibold">— Storm aftermath</p></blockquote>
          </div>
          <div className="text-center mt-10"><p className="text-navy-800 text-lg md:text-xl font-semibold max-w-2xl mx-auto">We hear you. Here&apos;s exactly how it works — 1-hour response, fixed price, insurance handled.</p></div>
        </div>
      </section>
