    ...
    <>
      ...
      <section className="bg-white px-4 py-16 md:py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { suburb: 'Manly', job: 'Burst-pipe ceiling section + cornice', time: 'Insurance job — restored in 2 visits', image: 'ceiling-repair-in-progress-northern-beaches.webp', alt: 'Water-damaged ceiling section being rebuilt by Jack\'s Plastering Northern Beaches — large oval area cut out for replacement' },
              { suburb: 'Dee Why', job: 'Storm-damaged ceiling, sagging plaster', time: 'Same-day inspection, fixed in 3 days', image: 'commercial-ceiling-plastering-sydney.webp', alt: 'Water-damage ceiling repair joint-finished and ready for paint — Sydney installation' },
              { suburb: 'Mona Vale', job: 'Brown stain + skim coat, paint-ready', time: 'One visit, 4 hours, done', image: 'outdoor-patio-ceiling-plastering-sydney.webp', alt: 'Outdoor patio ceiling water-damage repair in Sydney — gyprock reinstalled under timber framing' },
].map((j) => (
      ...
      <section className="bg-navy-900 px-4 py-16 md:py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { stars: 5, quote: 'Burst pipe upstairs trashed our ceiling. Jack arrived same day, photographed everything for the insurer, and had the whole ceiling restored within the week. The insurer dealt with him directly — we didn&apos;t chase anything.', name: 'Sarah M.', image: '/avatars/customer-sarah-m.webp', suburb: 'Manly' },
              { stars: 5, quote: 'Storm cracked the ceiling open. Jack responded in under an hour. Restored it in two visits and the room looks like nothing happened. 10/10.', name: 'David K.', image: '/avatars/customer-david-k.webp', suburb: 'Dee Why' },
              { stars: 5, quote: 'Brown stain spreading after a roof leak. Texted on Tuesday, quoted Wednesday, fixed Friday. Easy.', name: 'Rachel B.', image: '/avatars/customer-rachel-b.webp', suburb: 'Mona Vale' },
            ].map((t, i) => (
      ...
      <RelatedServices currentSlug="water-damage-ceiling-repair" />
